    ...
    <div className="flex flex-col gap-y-6 items-center text-center bg-primary pb-12 pt-12 lg:relative lg:-mt-[550px] lg:items-start lg:pl-12 lg:z-20">
      <div className="flex flex-col items-center text-center ">
        <span className="gap-x-2">
          <p className="text-secondary text-base font-medium lg:text-start "> Join other Sun harvesters
          </p>
          <h2 className="text-white text-[32px] font-semibold text-balance lg:text-start ">Make something awesome</h2>
        </span>
      </div>
      <div>
        <p className="text-white text-base font-extralight text-center w-[343px] lg:text-start ">
          Dui euismod iaculis libero, aliquet vitae et elementum porttitor.
          Eleifend mi tristique condimentum congue fusce nunc, donec magnis commodo.
        </p>
      </div>
      <Button color="secondary" className="lg:place-self-end lg:mr-12 lg:relative lg:bottom-36" >Request a Quote</Button>
      <div className="flex gap-x-4 mt-16 lg:mt-0 lg:max-w-[952px] lg:overflow-auto">
        <div className="md:flex md:flex-row md:gap-x-4 lg:gap-x-6">
          ...
          <Testimony className="hidden xl:block" testimony="Purus maecenas quis elit eu, aliquet. Tellus porttitor ut sollicitudin sit non fringilla. Quam nunc volutpat senectus neque eget amet pharetra, euismod. Tempus, nunc, molestie imperdiet curabitur commodo euismod." imageProfile="user_image_profile" name="Cameron Williamson" description="6KWh" />
        </div>
      </div>
