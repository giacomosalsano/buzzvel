...
export default function Services() {
  return (
    <div className="pt-[342px] pb-12 mx-4 mt-16 sm:mt-32">
      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-row-2 justify-center gap-y-6 gap-x-12 sm:gap-x-24 md:gap-x-48">
      ...
      <div className="mt-4 ">
        <Image className="relative -left-4 z-0 sm:w-[523px] sm:h-[850px] " src="/phone4.svg" alt="Phone illustration" width={523} height={599.56} />
      </div>
