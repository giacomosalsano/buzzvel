...
export default function Services() {
  return (
    <div className="pt-[342px] pb-12 mx-4 mt-16 sm:mt-32 lg:mt-16 lg:justify-between ">
      <div className="flex flex-col gap-y-6 items-center text-center mb-16 lg:relative lg:left-0 lg:top-72 lg:ml-96 xl:ml-0 xl:translate-y-80">
      ...
      <div className="flex flex-col gap-y-6 lg:relative lg:left-80 lg:top-72 lg:w-[600px] xl:translate-y-80 xl:translate-x-[640px] ">
